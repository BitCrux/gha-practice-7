...
def run():
    # With Docker -> for accessing inputs special environment variables are used. (Auto generated vars by GHA)
    # GitHub Actions generate for each input a env var which starts with INPUT_<input name>
